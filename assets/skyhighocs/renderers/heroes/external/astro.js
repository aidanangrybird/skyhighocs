...
function initAstroAnimations(renderer) {
  //Aiming
  addAnimation(renderer, "astro.CANNON", "skyhighocs:astro_aim").setData((entity, data) => {
    data.load(entity.getInterpolatedData("skyhighocs:dyn/arm_cannon_timer") + getHoloBoolean(entity, "holoArmCannon"));
  })
  ...
  addFlightIdleAnimation(renderer, "astro.IDLE", "skyhighocs:flight/astro_idle");
  ...
  addAnimation(renderer, "astro.HOLOGRAM_FLIGHT", "skyhighocs:astro_holo_flight").setData((entity, data) => {
...
function headAnimations(entity, data) {
  ...
  data.load(2, entity.getInterpolatedData("skyhighocs:dyn/arm_cannon_timer") + getHoloBoolean(entity, "holoArmCannon"));
  data.load(3, entity.getInterpolatedData("skyhighocs:dyn/dual_arm_cannon_timer") + getHoloBoolean(entity, "holoDualCannons"));
...
function bodyAnimations(entity, data) {
  data.load(0, entity.getInterpolatedData("fiskheroes:beam_charge") + entity.getInterpolatedData("skyhighocs:dyn/machine_gun_open_timer"));
  data.load(1, entity.getInterpolatedData("skyhighocs:dyn/torso_front_open_timer"));
  data.load(2, entity.getInterpolatedData("skyhighocs:dyn/torso_back_open_timer"));
  data.load(3, entity.getInterpolatedData("skyhighocs:dyn/shorts_front_open_timer"));
  data.load(4, entity.getInterpolatedData("skyhighocs:dyn/shorts_back_open_timer"));
  data.load(5, entity.getInterpolatedData("skyhighocs:dyn/core_open_timer"));
};

function leftArmAnimations(entity, data) {
  data.load(0, entity.getInterpolatedData("skyhighocs:dyn/dual_arm_cannon_timer") + getHoloBoolean(entity, "holoDualCannons"));
  data.load(1, entity.getInterpolatedData("skyhighocs:dyn/left_arm_outer_open_timer"));
  data.load(2, entity.getInterpolatedData("skyhighocs:dyn/left_cannon_outer_open_timer"));
  data.load(3, entity.getInterpolatedData("skyhighocs:dyn/left_cannon_inner_open_timer"));
};

function rightArmAnimations(entity, data) {
  data.load(0, entity.getInterpolatedData("skyhighocs:dyn/arm_cannon_timer") + entity.getInterpolatedData("skyhighocs:dyn/dual_arm_cannon_timer") + getHoloBoolean(entity, "holoArmCannon") + getHoloBoolean(entity, "holoDualCannons"));
  data.load(1, entity.getInterpolatedData("skyhighocs:dyn/right_arm_outer_open_timer"));
  data.load(2, entity.getInterpolatedData("skyhighocs:dyn/right_cannon_outer_open_timer"));
  data.load(3, entity.getInterpolatedData("skyhighocs:dyn/right_cannon_inner_open_timer"));
};

function leftLegAnimations(entity, data) {
  data.load(0, entity.getInterpolatedData("fiskheroes:flight_timer") + getHoloBoolean(entity, "holoFlight"));
  data.load(1, entity.getInterpolatedData("fiskheroes:flight_boost_timer") + getHoloBooleans(entity, "holoFlight", "holoBoostFlight"));
  data.load(2, entity.getInterpolatedData("skyhighocs:dyn/left_boot_front_open_timer"));
  data.load(3, entity.getInterpolatedData("skyhighocs:dyn/left_boot_back_open_timer"));
  ...
  data.load(6, entity.getInterpolatedData("skyhighocs:dyn/left_boot_open_timer"));
};

function rightLegAnimations(entity, data) {
  data.load(0, entity.getInterpolatedData("fiskheroes:flight_timer") + getHoloBoolean(entity, "holoFlight"));
  data.load(1, entity.getInterpolatedData("fiskheroes:flight_boost_timer") + getHoloBooleans(entity, "holoFlight", "holoBoostFlight"));
  data.load(2, entity.getInterpolatedData("skyhighocs:dyn/right_boot_front_open_timer"));
  data.load(3, entity.getInterpolatedData("skyhighocs:dyn/right_boot_back_open_timer"));
  ...
  data.load(6, entity.getInterpolatedData("skyhighocs:dyn/right_boot_open_timer"));
};
