...
function initBoosters(renderer, colors) {
  ...
  var obj = {
    ...
    renderBoosters: (entity, renderLayer, isFirstPersonArm) => {
      ...
      //lineLegMiddle = (2 * boost) + ((1 + f * boosterLegLeft.flutter / 4) * 1.25 * 1.25 / 8);
      //lineLegCenter = (2 * boost) + ((1 + f * boosterLegLeft.flutter / 4) * 1 * 1 / 8);
      //Edge
      ...
      //lineLegMiddle = (2 * boost) + ((1 + f * boosterLegRight.flutter / 4) * 1.25 * 1.25 / 8);
      //lineLegCenter = (2 * boost) + ((1 + f * boosterLegRight.flutter / 4) * 1 * 1 / 8);
      //Edge
