...
function initLeftArmBeams(renderer, color) {
  ...
  var chargedBeamFlush = bindBeam(renderer, "fiskheroes:charged_beam", "skyhighocs:cannons_charged_beam", "leftArm", color, positionFlush);
...
function initRightArmBeams(renderer, color) {
  ...
  var chargedBeamFlush = bindBeam(renderer, "fiskheroes:charged_beam", "skyhighocs:cannons_charged_beam", "rightArm", color, positionFlush);
  chargedBeamFlush.setParticles(renderer.createResource("PARTICLE_EMITTER", "fiskheroes:impact_charged_beam"));
...
function initHeadBeams(renderer, color) {
  ...
  var chargedBeamFlush = bindBeam(renderer, "fiskheroes:charged_beam", "skyhighocs:cannons_charged_beam", "head", color, positionFlush);
  chargedBeamFlush.setParticles(renderer.createResource("PARTICLE_EMITTER", "fiskheroes:impact_charged_beam"));
  ...
  var screamFlush = bindBeam(renderer, "fiskheroes:energy_projection", "skyhighocs:scream", "head", color, [
