function initLeftLegBoosters(renderer, model, color) {
  ...
  var obj = {
    ...
    render: (entity, renderLayer, isFirstPersonArm) => {
      //Main
      //Equations
      var data_0 = getHoloBooleans(entity, "holoFlight", "rocketsLegs") + entity.getInterpolatedData("fiskheroes:flight_timer")*((Math.sin(((5*Math.min(Math.max(entity.getInterpolatedData("skyhighocs:dyn/rockets_legs_timer"), 0.8), 1.0) - 4) * 2.0 - 1.0) * Math.PI / 2.0) + 1.0) / 2.0);
      var data_1 = getHoloBoolean(entity, "holoBoostFlight") + entity.getInterpolatedData("fiskheroes:flight_boost_timer")
      var boost = data_1;
      var flight = data_0;
      var innerRockets = entity.getData("skyhighocs:dyn/rocket_inner_legs_timer");
      ...
      //Booster
      //Equations
      var data_0 = getHoloBooleans(entity, "holoFlight", "rocketsAux") + entity.getInterpolatedData("fiskheroes:flight_timer")*((Math.sin(((5*Math.min(Math.max(entity.getInterpolatedData("skyhighocs:dyn/rockets_aux_timer"), 0.8), 1.0) - 4) * 2.0 - 1.0) * Math.PI / 2.0) + 1.0) / 2.0);
      var data_1 = getHoloBoolean(entity, "holoBoostFlight") + entity.getInterpolatedData("fiskheroes:flight_boost_timer")
      var boost = data_1;
      var flight = data_0;
      var b = Math.min(Math.max(boost * 3 - 1.25, 0), 1);
...
function initBodyBoosters(renderer, model, color) {
  ...
  var obj = {
    ...
    render: (entity, renderLayer, isFirstPersonArm) => {
      //Equations
      var data_0 = getHoloBooleans(entity, "holoFlight", "rocketsBody") + entity.getInterpolatedData("fiskheroes:flight_timer")*((Math.sin(((5*Math.min(Math.max(entity.getInterpolatedData("skyhighocs:dyn/rockets_body_timer"), 0.8), 1.0) - 4) * 2.0 - 1.0) * Math.PI / 2.0) + 1.0) / 2.0);
      var data_1 = getHoloBoolean(entity, "holoBoostFlight") + entity.getInterpolatedData("fiskheroes:flight_boost_timer")
      var boost = data_1;
      var flight = data_0;
      var b = Math.min(Math.max(boost * 3 - 1.25, 0), 1);
      ...
      //Beams
      lineLeftEdge.end.y = lineLeftMiddle.end.y = lineLeftCenter.end.y = ((0.5*boost + 1 + f * boosterLeft.flutter / 4) * 2.5 * 1.5 / 8);
      ...
      //Beams
      lineRightEdge.end.y = lineRightMiddle.end.y = lineRightCenter.end.y = ((0.5*boost + 1 + f * boosterRight.flutter / 4) * 2.5 * 1.5 / 8);
