...
loadTextures({
  "base": "skyhighocs:grand/grand_stelar_base",
  "lights": "skyhighocs:grand/grand_stelar_lights",
  "base_wave_change": "skyhighocs:grand/grand_stelar_wave_change.tx.json",
  "lights_wave_change": "skyhighocs:grand/grand_stelar_wave_change_lights.tx.json",
  "wave_changing_lights": "skyhighocs:grand/grand_stelar_wave_changing_lights.tx.json",
  "predation_sides_wave_changing_lights": "skyhighocs:grand/grand_stelar_predation_sides_wave_changing_lights.tx.json",
  "predation_front_wave_changing_lights": "skyhighocs:grand/grand_stelar_predation_front_wave_changing_lights.tx.json",
  "sword_blade": "skyhighocs:grand/grand_stelar_sword_blade.tx.json",
  "sword": "skyhighocs:grand/grand_stelar_sword.tx.json",
  "sword_lights": "skyhighocs:grand/grand_stelar_sword_lights.tx.json",
  "sword_wave_changing_lights": "skyhighocs:grand/grand_stelar_sword_wave_changing_lights.tx.json",
  "sword_sides": "skyhighocs:grand/grand_stelar_sword_sides.tx.json",
  "sword_front": "skyhighocs:grand/grand_stelar_sword_front.tx.json",
  "meteor_strike_sides": "skyhighocs:grand/grand_stelar_meteor_strike_sides.tx.json",
  "meteor_strike_sides_lights": "skyhighocs:grand/grand_stelar_meteor_strike_sides_lights.tx.json",
  "meteor_strike_front_lights": "skyhighocs:grand/grand_stelar_meteor_strike_front_lights.tx.json",
  "gravity_strike_sides": "skyhighocs:grand/grand_stelar_gravity_strike_sides.tx.json",
  "gravity_strike_sides_lights": "skyhighocs:grand/grand_stelar_gravity_strike_sides_lights.tx.json",
  "gravity_strike_front": "skyhighocs:grand/grand_stelar_gravity_strike_front.tx.json",
  "gravity_strike_front_lights": "skyhighocs:grand/grand_stelar_gravity_strike_front_lights.tx.json",
  "ember_ray_sides": "skyhighocs:grand/grand_stelar_ember_ray_sides.tx.json",
  "ember_ray_sides_lights": "skyhighocs:grand/grand_stelar_ember_ray_sides_lights.tx.json",
  "ember_ray_front": "skyhighocs:grand/grand_stelar_ember_ray_front.tx.json",
  "ember_ray_front_lights": "skyhighocs:grand/grand_stelar_ember_ray_front_lights.tx.json",
  "head_right": "skyhighocs:grand/grand_stelar_singularity_right.tx.json",
  "head_right_wave_change": "skyhighocs:grand/grand_stelar_singularity_right_wave_change.tx.json",
  "head_right_wave_change_lights": "skyhighocs:grand/grand_stelar_singularity_right_wave_change_lights.tx.json",
  "head_right_lights": "skyhighocs:grand/grand_stelar_singularity_right_lights.tx.json",
  "head_right_wave_changing_lights": "skyhighocs:grand/grand_stelar_singularity_right_wave_changing_lights.tx.json",
  "head_left": "skyhighocs:grand/grand_stelar_singularity_left.tx.json",
  "head_left_wave_change": "skyhighocs:grand/grand_stelar_singularity_left_wave_change.tx.json",
  "head_left_lights": "skyhighocs:grand/grand_stelar_singularity_left_lights.tx.json",
  "head_left_wave_change_lights": "skyhighocs:grand/grand_stelar_singularity_left_wave_change_lights.tx.json",
  "head_left_wave_changing_lights": "skyhighocs:grand/grand_stelar_singularity_left_wave_changing_lights.tx.json",
  "head_top": "skyhighocs:grand/grand_stelar_singularity_top.tx.json",
  "head_top_wave_change": "skyhighocs:grand/grand_stelar_singularity_top_wave_change.tx.json",
  "head_top_lights": "skyhighocs:grand/grand_stelar_singularity_top_lights.tx.json",
  "head_top_wave_change_lights": "skyhighocs:grand/grand_stelar_singularity_top_wave_change_lights.tx.json",
  "head_top_wave_changing_lights": "skyhighocs:grand/grand_stelar_singularity_top_wave_changing_lights.tx.json",
  "head_bottom": "skyhighocs:grand/grand_stelar_singularity_bottom.tx.json",
  "head_bottom_wave_change": "skyhighocs:grand/grand_stelar_singularity_bottom_wave_change.tx.json",
  "head_bottom_lights": "skyhighocs:grand/grand_stelar_singularity_bottom_lights.tx.json",
  "head_bottom_wave_change_lights": "skyhighocs:grand/grand_stelar_singularity_bottom_wave_change_lights.tx.json",
  "head_bottom_wave_changing_lights": "skyhighocs:grand/grand_stelar_singularity_bottom_wave_changing_lights.tx.json",
  "head_front": "skyhighocs:grand/grand_stelar_singularity_front.tx.json",
  "head_front_lights": "skyhighocs:grand/grand_stelar_singularity_front_lights.tx.json",
  "head_front_wave_change": "skyhighocs:grand/grand_stelar_singularity_front_wave_change.tx.json",
  "head_front_wave_changing_lights": "skyhighocs:grand/grand_stelar_singularity_front_wave_changing_lights.tx.json",
  "transer": "skyhighocs:grand/grand_stelar_transer.tx.json",
  "transer_wave_change": "skyhighocs:grand/grand_stelar_transer_wave_change.tx.json",
  "visualizer_lights": "skyhighocs:grand/grand_stelar_visualizer_lights.tx.json",
  "visualizer_lights_wave_change": "skyhighocs:grand/grand_stelar_visualizer_lights_wave_change.tx.json",
  "transer_default": "skyhighocs:grand/grand_stelar_transer",
  "transer_default_lights": "skyhighocs:grand/grand_stelar_transer_lights",
  "shield": "skyhighocs:grand/grand_stelar_shield",
  "shield_lights": "skyhighocs:grand/grand_stelar_shield_lights",
  "katana": "skyhighocs:grand/grand_stelar_katana",
  "katana_lights": "skyhighocs:grand/grand_stelar_katana_lights",
  "scythe": "skyhighocs:grand/grand_stelar_scythe",
  "scythe_lights": "skyhighocs:grand/grand_stelar_scythe_lights",
  "rifle": "skyhighocs:grand/grand_stelar_rifle",
  "rifle_lights": "skyhighocs:grand/grand_stelar_rifle_lights"
});
...
function initEffects(renderer) {
  ...
  stelar.bindBeam(renderer, "fiskheroes:energy_projection", "skyhighocs:wave_ember_ray_grand", "rightArm", 0xFF0000, [
    { "firstPerson": [-4.5, 3.75, -8.0], "offset": [-1.0, 9.0, -0.5], "size": [3.0, 3.0] }
  ]).setParticles(renderer.createResource("PARTICLE_EMITTER", "fiskheroes:impact_charged_beam"));
  stuff.bindCloud(renderer, "fiskheroes:telekinesis", "skyhighocs:wave_gravity_strike_grand");
  var chain = stuff.bindCloud(renderer, "fiskheroes:telekinesis_chain", "skyhighocs:wave_gravity_strike_grand");
  chain.anchor.set("rightArm");
  chain.setOffset(-0.5, 10.0, 0.0);
  chain.setFirstPerson(-4.75, 4.0, -8.5);
  stuff.bindFlightTrail(renderer, "skyhighocs:grand_stelar_flight");
...
function render(entity, renderLayer, isFirstPersonArm) {
  ...
  if (renderLayer == "CHESTPLATE") {
    if (entity.getInterpolatedData("skyhighheroes:dyn/wave_changing_timer") > 0 || ((entity.as("DISPLAY").getDisplayType() == "DISPLAY_STAND" || entity.as("DISPLAY").getDisplayType() == "HOLOGRAM" || entity.as("DISPLAY").getDisplayType() == "ITERATOR_PREVIEW"))) {
      ...
      if (entity.getInterpolatedData("skyhighheroes:dyn/wave_changing_timer") == 1 && (entity.getInterpolatedData("skyhighheroes:dyn/sword_timer") < 1) && (entity.getInterpolatedData("skyhighocs:dyn/ember_ray_timer") < 1) && (entity.getInterpolatedData("skyhighocs:dyn/meteor_strike_timer") < 1) && (entity.getInterpolatedData("skyhighocs:dyn/gravity_strike_timer") < 1)) {
        headRight.render();
        headLeft.render();
        headTop.render();
        headBottom.render();
      ...
      if ((entity.getInterpolatedData("skyhighheroes:dyn/sword_timer") < 1) && (entity.getInterpolatedData("skyhighocs:dyn/ember_ray_timer") < 1) && (entity.getInterpolatedData("skyhighocs:dyn/meteor_strike_timer") < 1) && (entity.getInterpolatedData("skyhighocs:dyn/gravity_strike_timer") < 1)) {
    ...
    if (entity.getInterpolatedData("skyhighheroes:dyn/wave_changing_timer") == 1 && entity.getInterpolatedData("skyhighocs:dyn/ember_ray_timer") > 0) {
    ...
    if (entity.getInterpolatedData("skyhighheroes:dyn/wave_changing_timer") == 1 && entity.getInterpolatedData("skyhighocs:dyn/meteor_strike_timer") > 0) {
    ...
    if (entity.getInterpolatedData("skyhighheroes:dyn/wave_changing_timer") == 1 && entity.getInterpolatedData("skyhighocs:dyn/gravity_strike_timer") > 0) {
