...
loadTextures({
  ...
  "predation_sides_wave_changing_lights": "skyhighocs:aidan/squall_vortex_predation_sides_wave_changing_lights.tx.json",
  "predation_front_wave_changing_lights": "skyhighocs:aidan/squall_vortex_predation_front_wave_changing_lights.tx.json",
  ...
  "head_right_wave_change": "skyhighocs:aidan/jet_streak_right_wave_change.tx.json",
  "head_right_wave_change_lights": "skyhighocs:aidan/jet_streak_right_wave_change_lights.tx.json",
  "head_right_lights": "skyhighocs:aidan/jet_streak_right_lights.tx.json",
  "head_right_wave_changing_lights": "skyhighocs:aidan/jet_streak_right_wave_changing_lights.tx.json",
  "head_left": "skyhighocs:aidan/jet_streak_left.tx.json",
  "head_left_wave_change": "skyhighocs:aidan/jet_streak_left_wave_change.tx.json",
  "head_left_lights": "skyhighocs:aidan/jet_streak_left_lights.tx.json",
  "head_left_wave_change_lights": "skyhighocs:aidan/jet_streak_left_wave_change_lights.tx.json",
  "head_left_wave_changing_lights": "skyhighocs:aidan/jet_streak_left_wave_changing_lights.tx.json",
  "head_top": "skyhighocs:aidan/jet_streak_top.tx.json",
  "head_top_wave_change": "skyhighocs:aidan/jet_streak_top_wave_change.tx.json",
  "head_top_lights": "skyhighocs:aidan/jet_streak_top_lights.tx.json",
  "head_top_wave_change_lights": "skyhighocs:aidan/jet_streak_top_wave_change_lights.tx.json",
  "head_top_wave_changing_lights": "skyhighocs:aidan/jet_streak_top_wave_changing_lights.tx.json",
  "head_bottom": "skyhighocs:aidan/jet_streak_bottom.tx.json",
  "head_bottom_wave_change": "skyhighocs:aidan/jet_streak_bottom_wave_change.tx.json",
  "head_bottom_lights": "skyhighocs:aidan/jet_streak_bottom_lights.tx.json",
  "head_bottom_wave_change_lights": "skyhighocs:aidan/jet_streak_bottom_wave_change_lights.tx.json",
  "head_bottom_wave_changing_lights": "skyhighocs:aidan/jet_streak_bottom_wave_changing_lights.tx.json",
  "head_front": "skyhighocs:aidan/jet_streak_front.tx.json",
  "head_front_wave_change": "skyhighocs:aidan/jet_streak_front_wave_change.tx.json",
  "head_front_wave_changing_lights": "skyhighocs:aidan/jet_streak_front_wave_changing_lights.tx.json",
...
function render(entity, renderLayer, isFirstPersonArm) {
  ...
  if (renderLayer == "CHESTPLATE") {
    ...
    if (entity.getInterpolatedData("skyhighheroes:dyn/wave_changing_timer") > 0 || (entity.as("DISPLAY").getDisplayType() == "DATABASE_PREVIEW" || entity.as("DISPLAY").getDisplayType() == "HOLOGRAM" || entity.as("DISPLAY").getDisplayType() == "ITERATOR_PREVIEW" || entity.as("DISPLAY").getDisplayType() == "DISPLAY_STAND")) {
      ...
      if (entity.getInterpolatedData("skyhighheroes:dyn/wave_changing_timer") == 1 && (entity.getInterpolatedData("skyhighheroes:dyn/sword_timer") < 1) && (entity.getInterpolatedData("skyhighocs:dyn/lightning_timer") < 1) && (entity.getInterpolatedData("skyhighocs:dyn/derecho_timer") < 1) && (entity.getInterpolatedData("skyhighocs:dyn/hail_cannon_timer") < 1) || entity.as("DISPLAY").getDisplayType() == "DATABASE_PREVIEW") {
        headRight.render();
        headLeft.render();
        headTop.render();
        headBottom.render();
