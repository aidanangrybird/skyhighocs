...
function init(hero) {
  ...
  hero.addPrimaryEquipment("fiskheroes:suit_data_drive@1{display:{Name:\u00A74Cyber Asteroid's Data Drive}}", true, item => (item.damage() == 1 && item.displayName() == "\u00A74Cyber Asteroid's Data Drive"));
