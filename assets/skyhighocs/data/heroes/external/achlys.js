...
function init(transer) {
  ...
  return {
    ...
    canAim: function (entity) {
      return (entity.getHeldItem().isEmpty() || entity.getHeldItem().name() == "fiskheroes:chronos_rifle") && entity.getData("fiskheroes:flight_boost_timer") == 0 && entity.getData("skyhighheroes:dyn/battle_card") == 0 && entity.getData("skyhighocs:dyn/achlys_timer") == 0 && entity.getData("skyhighheroes:dyn/wave_changing_timer") == 1;
    },
