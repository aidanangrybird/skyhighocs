  ...
  return {
    ...
    keyBinds: function (hero) {
      ...
      hero.addKeyBindFunc("COLD_TEMPERATURE", (player, manager) => {
        if (player.getUUID() == "e51532a1-19fc-4d4f-9da0-f952c4645891") {
          system.shoutMessage(player, "\u00A7r<\u00A75Achlys\u00A7r> You are too cold for us to EM Wave Change.", 16);
        } else {
          system.shoutMessage(player, "<\u00A75Achlys\u00A7r> Who are you?", 16);
        };
        return true;
      ...
      hero.addKeyBindFunc("HOT_TEMPERATURE", (player, manager) => {
        if (player.getUUID() == "e51532a1-19fc-4d4f-9da0-f952c4645891") {
          system.shoutMessage(player, "\u00A7r<\u00A75Achlys\u00A7r> You are too hot for us to EM Wave Change.", 16);
        } else {
          system.shoutMessage(player, "<\u00A75Achlys\u00A7r> Who are you?", 16);
        };
        return true;
