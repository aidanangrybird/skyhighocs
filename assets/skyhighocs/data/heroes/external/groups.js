      ...
      if (arguments.length > 1 && arguments.length < 4) {
        switch (arguments[1]) {
          ...
          case "list":
            ...
            break;
          case "addMem":
            (arguments.length == 3) ? addGroupMember(entity, manager, entity.getData("skyhighocs:dyn/group_name"), arguments[2]) : system.moduleMessage(this, entity, "<n>!g addMem <nh><name>");
            break;
          case "remMem":
            (arguments.length == 3) ? removeGroupMember(entity, manager, entity.getData("skyhighocs:dyn/group_name"), arguments[2]) : system.moduleMessage(this, entity, "<n>!g remMem <nh><name>");
            break;
          case "listMem":
