...
function initModule(system) {
  ...
  return {
          ...
          case "set":
            switch (argList[2]) {
              case "holo":
                ...
                break;
              case "flushHead":
                manager.setData(entity, "skyhighocs:dyn/cannon_head_flush_enabled", ((argList[2] == "true") ? true : (argList[2] == "false") ? false : entity.getData("skyhighocs:dyn/cannon_head_flush_enabled")));
                ...
                break;
              case "flushLeftArm":
                manager.setData(entity, "skyhighocs:dyn/cannon_left_arm_flush_enabled", ((argList[2] == "true") ? true : (argList[2] == "false") ? false : entity.getData("skyhighocs:dyn/cannon_left_arm_flush_enabled")));
                ...
                break;
              case "flushRightArm":
                manager.setData(entity, "skyhighocs:dyn/cannon_right_arm_flush_enabled", ((argList[2] == "true") ? true : (argList[2] == "false") ? false : entity.getData("skyhighocs:dyn/cannon_right_arm_flush_enabled")));
    ...
    tickHandler: function (entity, manager) {
      ...
      manager.setData(entity, "skyhighocs:dyn/cannon_head_flush", entity.getData("skyhighocs:dyn/cannon_right_arm_flush_enabled"));
      manager.setData(entity, "skyhighocs:dyn/cannon_left_arm_flush", entity.getData("skyhighocs:dyn/cannon_right_arm_flush_enabled"));
