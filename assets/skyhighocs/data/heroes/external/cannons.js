...
function initModule(system) {
  ...
  return {
      ...
      if (argList.length > 1 && argList.length < 5) {
        ...
        switch (argList[1]) {
          ...
          case "status":
            ...
            system.moduleMessage(this, entity, "<n>Left Head: <nh>" + ((entity.getData("skyhighocs:dyn/cannon_head_left_deploy_timer") > 0) || headSet ? "DEPLOYED" : "RETRACTED"));
            system.moduleMessage(this, entity, "<n>Right Head: <nh>" + ((entity.getData("skyhighocs:dyn/cannon_head_right_deploy_timer") > 0) || headSet ? "DEPLOYED" : "RETRACTED"));
    ...
    tickHandler: function (entity, manager) {
      ...
      manager.setData(entity, "skyhighocs:dyn/cannon_head_flush", nbt.getBoolean("flushHeadCannons"));
      manager.setData(entity, "skyhighocs:dyn/cannon_left_arm_flush", nbt.getBoolean("flushLeftArmCannons"));
      manager.setData(entity, "skyhighocs:dyn/cannon_right_arm_flush", nbt.getBoolean("flushRightArmCannons"));
