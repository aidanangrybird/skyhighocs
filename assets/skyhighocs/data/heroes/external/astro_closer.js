  ...
  return {
    ...
    commandHandler: function (entity, manager, argList) {
      if (argList.length > 1 && argList.length < 3) {
        switch(argList[1]) {
          case "headTop":
            manager.setData(entity, "skyhighocs:dyn/head_top_front_open", false);
            manager.setData(entity, "skyhighocs:dyn/head_top_back_open", false);
            system.moduleMessage(this, entity, "<n>Closing top head!");
            break;
          case "headBottom":
            manager.setData(entity, "skyhighocs:dyn/head_bottom_front_open", false);
            manager.setData(entity, "skyhighocs:dyn/head_bottom_back_open", false);
          ...
          case "head":
            ...
            break;
          case "bodyUpper":
            manager.setData(entity, "skyhighocs:dyn/body_upper_front_open", false);
            manager.setData(entity, "skyhighocs:dyn/body_upper_back_open", false);
            system.moduleMessage(this, entity, "<n>Closing upper body!");
            break;
          case "bodyLower":
            manager.setData(entity, "skyhighocs:dyn/body_lower_front_open", false);
            manager.setData(entity, "skyhighocs:dyn/body_lower_back_open", false);
          ...
          case "bodyLowerBack":
            ...
            break;
          case "machineGun":
            manager.setData(entity, "skyhighocs:dyn/body_machine_gun_open", false);
          ...
          case "body":
            ...
            break;
          case "leftArmCannon":
            manager.setData(entity, "skyhighocs:dyn/left_arm_cannon_outer_open", false);
            manager.setData(entity, "skyhighocs:dyn/left_arm_cannon_inner_open", false);
          ...
          case "leftArmCannonInner":
            ...
            break;
          case "leftArmOuter":
            manager.setData(entity, "skyhighocs:dyn/left_arm_outer_open", false);
          ...
          case "leftArm":
            ...
            break;
          case "rightArmCannon":
            manager.setData(entity, "skyhighocs:dyn/right_arm_cannon_outer_open", false);
            manager.setData(entity, "skyhighocs:dyn/right_arm_cannon_inner_open", false);
          ...
          case "rightArmCannonInner":
            ...
            break;
          case "rightArmOuter":
            manager.setData(entity, "skyhighocs:dyn/right_arm_outer_open", false);
          ...
          case "rightArm":
            ...
            break;
          case "leftLegUpper":
            manager.setData(entity, "skyhighocs:dyn/left_leg_front_open", false);
            manager.setData(entity, "skyhighocs:dyn/left_leg_back_open", false);
            system.moduleMessage(this, entity, "<n>Closing upper left leg!");
            break;
          case "leftLegBoot":
            manager.setData(entity, "skyhighocs:dyn/left_leg_boot_front_open", false);
            manager.setData(entity, "skyhighocs:dyn/left_leg_boot_back_open", false);
            manager.setData(entity, "skyhighocs:dyn/left_leg_boot_open", false);
          ...
          case "leftLeg":
            ...
            break;
          case "rightLegUpper":
            manager.setData(entity, "skyhighocs:dyn/right_leg_front_open", false);
            manager.setData(entity, "skyhighocs:dyn/right_leg_back_open", false);
            system.moduleMessage(this, entity, "<n>Closing upper right leg!");
            break;
          case "rightLegBoot":
            manager.setData(entity, "skyhighocs:dyn/right_leg_boot_front_open", false);
            manager.setData(entity, "skyhighocs:dyn/right_leg_boot_back_open", false);
            manager.setData(entity, "skyhighocs:dyn/right_leg_boot_open", false);
