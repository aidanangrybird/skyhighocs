      ...
      if (argList.length > 1 && argList.length < 3) {
        switch(argList[1]) {
          ...
          case "head":
            ...
            break;
          case "torso":
            manager.setData(entity, "skyhighocs:dyn/torso_front_open", false);
            manager.setData(entity, "skyhighocs:dyn/torso_back_open", false);
            system.moduleMessage(this, entity, "<n>Closing upper body!");
            break;
          case "shorts":
            manager.setData(entity, "skyhighocs:dyn/shorts_front_open", false);
            manager.setData(entity, "skyhighocs:dyn/shorts_back_open", false);
          ...
          case "shortsBack":
            ...
            break;
          case "machineGun":
            manager.setData(entity, "skyhighocs:dyn/machine_gun_open", false);
            system.moduleMessage(this, entity, "<n>Closing body machine guns!");
            break;
          case "core":
            manager.setData(entity, "skyhighocs:dyn/core_open", false);
          ...
          case "body":
            ...
            break;
          case "leftCannon":
            manager.setData(entity, "skyhighocs:dyn/left_cannon_outer_open", false);
            manager.setData(entity, "skyhighocs:dyn/left_cannon_inner_open", false);
          ...
          case "leftArm":
            ...
            break;
          case "rightCannon":
            manager.setData(entity, "skyhighocs:dyn/right_cannon_outer_open", false);
            manager.setData(entity, "skyhighocs:dyn/right_cannon_inner_open", false);
          ...
          case "leftLeg":
            ...
            break;
          case "leftBoot":
            manager.setData(entity, "skyhighocs:dyn/left_boot_front_open", false);
            manager.setData(entity, "skyhighocs:dyn/left_boot_back_open", false);
            manager.setData(entity, "skyhighocs:dyn/left_boot_open", false);
          ...
          case "rightLeg":
            ...
            break;
          case "rightBoot":
            manager.setData(entity, "skyhighocs:dyn/right_boot_front_open", false);
            manager.setData(entity, "skyhighocs:dyn/right_boot_back_open", false);
            manager.setData(entity, "skyhighocs:dyn/right_boot_open", false);
