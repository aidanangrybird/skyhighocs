function visualizerToggle(player, manager) {
  manager.setData(player, "skyhighocs:dyn/visualizer_toggle", !player.getData("skyhighocs:dyn/visualizer_toggle"));
  manager.setData(player, "fiskheroes:penetrate_martian_invis", player.getData("skyhighocs:dyn/visualizer_toggle"));
  return true;
};

function cycleClothes(player, manager) {
  manager.setData(player, "skyhighocs:dyn/stelar_clothes", player.getData("skyhighocs:dyn/stelar_clothes") + 1);
  if (player.getData("skyhighocs:dyn/stelar_clothes") > 3) {
    manager.setData(player, "skyhighocs:dyn/stelar_clothes", 0);
  };
  return true;
};

function hoodToggle(player, manager) {
  manager.setData(player, "skyhighocs:dyn/hood_toggle", !player.getData("skyhighocs:dyn/hood_toggle"));
  return true;
};
