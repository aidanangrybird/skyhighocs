  ...
  return {
    ...
    commandHandler: function (entity, manager, argList) {
      if (argList.length > 1 && argList.length < 3) {
        switch(argList[1]) {
          case "headTop":
            manager.setData(entity, "skyhighocs:dyn/head_top_front_open", true);
            manager.setData(entity, "skyhighocs:dyn/head_top_back_open", true);
            system.moduleMessage(this, entity, "<n>Opening top head!");
            break;
          case "headBottom":
            manager.setData(entity, "skyhighocs:dyn/head_bottom_front_open", true);
            manager.setData(entity, "skyhighocs:dyn/head_bottom_back_open", true);
          ...
          case "head":
            ...
            break;
          case "torso":
            manager.setData(entity, "skyhighocs:dyn/torso_front_open", true);
            manager.setData(entity, "skyhighocs:dyn/torso_back_open", true);
            system.moduleMessage(this, entity, "<n>Opening torso!");
            break;
          case "shorts":
            manager.setData(entity, "skyhighocs:dyn/shorts_front_open", true);
            manager.setData(entity, "skyhighocs:dyn/shorts_back_open", true);
            system.moduleMessage(this, entity, "<n>Opening shorts!");
            break;
          case "bodyFront":
            manager.setData(entity, "skyhighocs:dyn/torso_front_open", true);
            manager.setData(entity, "skyhighocs:dyn/shorts_front_open", true);
          ...
          case "shortsBack":
            ...
            break;
          case "core":
            manager.setData(entity, "skyhighocs:dyn/core_open", true);
            system.moduleMessage(this, entity, "<n>Opening core!");
            break;
          case "machineGun":
            manager.setData(entity, "skyhighocs:dyn/machine_gun_open", true);
          ...
          case "body":
            ...
            break;
          case "leftCannon":
            manager.setData(entity, "skyhighocs:dyn/left_cannon_outer_open", true);
            manager.setData(entity, "skyhighocs:dyn/left_cannon_inner_open", true);
          ...
          case "leftCannonInner":
            ...
            break;
          case "leftArmOuter":
            manager.setData(entity, "skyhighocs:dyn/left_arm_outer_open", true);
          ...
          case "leftArm":
            ...
            break;
          case "rightCannon":
            manager.setData(entity, "skyhighocs:dyn/right_cannon_outer_open", true);
            manager.setData(entity, "skyhighocs:dyn/right_cannon_inner_open", true);
          ...
          case "rightCannonInner":
            ...
            break;
          case "rightArmOuter":
            manager.setData(entity, "skyhighocs:dyn/right_arm_outer_open", true);
          ...
          case "rightArm":
            ...
            break;
          case "leftLeg":
            manager.setData(entity, "skyhighocs:dyn/left_leg_front_open", true);
            manager.setData(entity, "skyhighocs:dyn/left_leg_back_open", true);
            system.moduleMessage(this, entity, "<n>Opening upper left leg!");
            break;
          case "leftBoot":
            manager.setData(entity, "skyhighocs:dyn/left_boot_front_open", true);
            manager.setData(entity, "skyhighocs:dyn/left_boot_back_open", true);
            manager.setData(entity, "skyhighocs:dyn/left_boot_open", true);
          ...
          case "leftLeg":
            ...
            break;
          case "rightLeg":
            manager.setData(entity, "skyhighocs:dyn/right_leg_front_open", true);
            manager.setData(entity, "skyhighocs:dyn/right_leg_back_open", true);
            system.moduleMessage(this, entity, "<n>Opening upper right leg!");
            break;
          case "rightBoot":
            manager.setData(entity, "skyhighocs:dyn/right_boot_front_open", true);
            manager.setData(entity, "skyhighocs:dyn/right_boot_back_open", true);
            manager.setData(entity, "skyhighocs:dyn/right_boot_open", true);
