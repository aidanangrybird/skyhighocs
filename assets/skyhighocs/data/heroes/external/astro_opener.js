      ...
      if (arguments.length > 1 && arguments.length < 3) {
        switch(arguments[1]) {
          ...
          case "head":
            ...
            break;
          case "bodyUpper":
            manager.setData(entity, "skyhighocs:dyn/body_upper_front_open", true);
            manager.setData(entity, "skyhighocs:dyn/body_upper_back_open", true);
            system.moduleMessage(this, entity, "<n>Opening upper body!");
            break;
          case "bodyLower":
            manager.setData(entity, "skyhighocs:dyn/body_lower_front_open", true);
            manager.setData(entity, "skyhighocs:dyn/body_lower_back_open", true);
          ...
          case "bodyLowerBack":
            ...
            break;
          case "machineGun":
            manager.setData(entity, "skyhighocs:dyn/body_machine_gun_open", true);
          ...
          case "body":
            ...
            break;
          case "leftArmCannon":
            manager.setData(entity, "skyhighocs:dyn/left_arm_cannon_outer_open", true);
            manager.setData(entity, "skyhighocs:dyn/left_arm_cannon_inner_open", true);
          ...
          case "leftArm":
            ...
            break;
          case "rightArmCannon":
            manager.setData(entity, "skyhighocs:dyn/right_arm_cannon_outer_open", true);
            manager.setData(entity, "skyhighocs:dyn/right_arm_cannon_inner_open", true);
          ...
          case "leftLegUpper":
            ...
            break;
          case "leftLegBoot":
            manager.setData(entity, "skyhighocs:dyn/left_leg_boot_front_open", true);
            manager.setData(entity, "skyhighocs:dyn/left_leg_boot_back_open", true);
            manager.setData(entity, "skyhighocs:dyn/left_leg_boot_open", true);
          ...
          case "rightLegUpper":
            ...
            break;
          case "rightLegBoot":
            manager.setData(entity, "skyhighocs:dyn/right_leg_boot_front_open", true);
            manager.setData(entity, "skyhighocs:dyn/right_leg_boot_back_open", true);
            manager.setData(entity, "skyhighocs:dyn/right_leg_boot_open", true);
