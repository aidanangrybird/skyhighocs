...
function initModule(system) {
  ...
  var mouthMultiTap = system.initMultiTap("skyhighocs:dyn/mouth");
  return {
    ...
    isKeyBindEnabled: function (entity, keyBind) {
      ...
      if (!system.isModuleDisabled(entity, this.name)) {
        ...
        if (keyBind == "MOUTH" && !entity.getData("skyhighocs:dyn/battle_mode")) {
          result = !mouth;
        };
        if (keyBind == "ENERGY_PROJECTION" && (entity.getData("skyhighocs:dyn/mouth_timer") == 1) && !entity.getData("skyhighocs:dyn/battle_mode")) {
          result = mouth;
        };
        if (keyBind == "SCREAM" && !entity.getData("skyhighocs:dyn/battle_mode")) {
          result = mouth;
        };
      };
      return result;
