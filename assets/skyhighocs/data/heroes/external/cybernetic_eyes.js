          ...
          case "set":
            switch(argList[2]) {
              case "lids":
                ...
                manager.setInterpolatedData(entity, "skyhighocs:dyn/prev_eye_left_lid_timer", system.round(entity.getData("skyhighocs:dyn/eye_left_lid_timer")));
                manager.setInterpolatedData(entity, "skyhighocs:dyn/prev_eye_right_lid_timer", system.round(entity.getData("skyhighocs:dyn/eye_right_lid_timer")));
                break;
              case "leftLid":
                manager.setShort(nbt, "eyeLeftLid", system.clamp(parseInt(argList[3]), 0, 100));
              ...
              case "X":
                ...
                manager.setInterpolatedData(entity, "skyhighocs:dyn/prev_eye_left_X_timer", system.round(entity.getData("skyhighocs:dyn/eye_left_X_timer")));
                manager.setInterpolatedData(entity, "skyhighocs:dyn/prev_eye_right_X_timer", system.round(entity.getData("skyhighocs:dyn/eye_right_X_timer")));
                break;
              case "leftX":
                manager.setShort(nbt, "eyeLeftX", system.clamp(parseInt(argList[3]), 0, 100));
              ...
              case "Y":
                ...
                manager.setInterpolatedData(entity, "skyhighocs:dyn/prev_eye_left_Y_timer", system.round(entity.getData("skyhighocs:dyn/eye_left_Y_timer")));
                manager.setInterpolatedData(entity, "skyhighocs:dyn/prev_eye_right_Y_timer", system.round(entity.getData("skyhighocs:dyn/eye_right_Y_timer")));
                break;
              case "leftY":
                manager.setShort(nbt, "eyeLeftY", system.clamp(parseInt(argList[3]), -100, 100));
