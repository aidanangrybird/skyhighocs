  ...
  return {
    emPowers: function () {
      return [
        ...
        "skyhighocs:blaze_buster"
      ];
    },
    powers: function () {
      return [
        "skyhighocs:singularity"
      ];
    },
    keyBinds: function (hero) {
      ...
      hero.addKeyBindFunc("DESYNCHRONIZE_WAVES", (player, manager) => {
        ...
        manager.setData(player, "skyhighocs:dyn/singularity_timer", 0);
        manager.setData(player, "skyhighocs:dyn/singularity", false);
    ...
    canAim: function (entity) {
      return (entity.getHeldItem().isEmpty() || entity.getHeldItem().name() == "fiskheroes:chronos_rifle") && entity.getData("fiskheroes:flight_boost_timer") == 0 && entity.getData("skyhighheroes:dyn/battle_card") == 0 && entity.getData("skyhighocs:dyn/singularity_timer") == 0 && entity.getData("skyhighheroes:dyn/wave_changing_timer") == 1;
    },
    isKeyBindEnabled: function (entity, keyBind) {
      var result = false;
      if (keyBind == "PREDATION") {
        result = entity.getData("skyhighheroes:dyn/wave_changing_timer") == 1 && (entity.getData("skyhighheroes:dyn/battle_card") > 0 || entity.getData("skyhighocs:dyn/singularity_timer") < 1);
      };
    ...
    tickHandler: function (entity, manager) {
      if (entity.getData("skyhighheroes:dyn/wave_changing_timer") == 1 && ((entity.getData("skyhighheroes:dyn/predation") && entity.getData("skyhighheroes:dyn/predation_timer") > 0 && entity.getData("skyhighheroes:dyn/predation_timer") < 1))) {
        ...
        manager.setData(entity, "skyhighocs:dyn/singularity", false);
      };
    },
    name: function () {
      return "singularity";
