  ...
  return {
    ...
    messageHandler: function (entity, name, range) {
      ...
      if (nbt.getTagList("groups").tagCount() > 0) {
        ...
        var chat = entity.getData("skyhighocs:dyn/group_selected");
    ...
    chatInfo: function (entity, manager, chat) {
      ...
      if (nbt.hasKey("groups")) {
        if (nbt.getTagList("groups").tagCount() > 0) {
          ...
          var chatIndex = groupList.indexOf(chat);
          if (chatIndex > -1) {
            manager.setData(entity, "skyhighocs:dyn/group_selected", chat);
    ...
    onInitSystem: function (entity, manager) {
      ...
      manager.setData(entity, "skyhighocs:dyn/group_selected", nbt.getString("groupSelected"));
    }
  };
};
