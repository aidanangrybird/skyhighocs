      ...
      if (argList.length > 1 && argList.length < 5) {
        ...
        switch(argList[1]) {
          ...
          case "status":
            ...
            system.moduleMessage(this, entity, "<n>Left Arm outer: <nh>" + ((entity.getData("skyhighocs:dyn/rocket_left_arm_outer_deploy_timer") > 0) || armsSet ? "DEPLOYED" : "RETRACTED"));
            system.moduleMessage(this, entity, "<n>Left Arm front: <nh>" + ((entity.getData("skyhighocs:dyn/rocket_left_arm_front_deploy_timer") > 0) || armsSet ? "DEPLOYED" : "RETRACTED"));
            system.moduleMessage(this, entity, "<n>Left Arm back: <nh>" + ((entity.getData("skyhighocs:dyn/rocket_left_arm_back_deploy_timer") > 0) || armsSet ? "DEPLOYED" : "RETRACTED"));
            system.moduleMessage(this, entity, "<n>right Arm outer: <nh>" + ((entity.getData("skyhighocs:dyn/rocket_right_arm_outer_deploy_timer") > 0) || armsSet ? "DEPLOYED" : "RETRACTED"));
            system.moduleMessage(this, entity, "<n>right Arm front: <nh>" + ((entity.getData("skyhighocs:dyn/rocket_right_arm_front_deploy_timer") > 0) || armsSet ? "DEPLOYED" : "RETRACTED"));
            system.moduleMessage(this, entity, "<n>right Arm back: <nh>" + ((entity.getData("skyhighocs:dyn/rocket_right_arm_back_deploy_timer") > 0) || armsSet ? "DEPLOYED" : "RETRACTED"));
            ...
            system.moduleMessage(this, entity, "<n>Left Leg inner: <nh>" + ((entity.getData("skyhighocs:dyn/rocket_left_leg_inner_deploy_timer") > 0) || legsSet ? "DEPLOYED" : "RETRACTED"));
            system.moduleMessage(this, entity, "<n>Left Leg outer: <nh>" + ((entity.getData("skyhighocs:dyn/rocket_left_leg_outer_deploy_timer") > 0) || legsSet ? "DEPLOYED" : "RETRACTED"));
            ...
            system.moduleMessage(this, entity, "<n>Right Leg inner: <nh>" + ((entity.getData("skyhighocs:dyn/rocket_right_leg_inner_deploy_timer") > 0) || legsSet ? "DEPLOYED" : "RETRACTED"));
            system.moduleMessage(this, entity, "<n>Right Leg outer: <nh>" + ((entity.getData("skyhighocs:dyn/rocket_right_leg_outer_deploy_timer") > 0) || legsSet ? "DEPLOYED" : "RETRACTED"));
