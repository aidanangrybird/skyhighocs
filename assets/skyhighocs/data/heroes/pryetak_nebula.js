...
function init(hero) {
  ...
  hero.setKeyBindEnabled((entity, keyBind) => {
    ...
    if (keyBind == "HOOD_TOGGLE") {
      return entity.getData("skyhighocs:dyn/wave_changing_timer") == 0 && entity.isSneaking() && entity.getData("skyhighocs:dyn/stelar_clothes") == 3;
    };
    ...
    if (keyBind == "SHAPE_SHIFT") {
      return entity.getData("skyhighocs:dyn/battle_card") == 0 && ((entity.getData("skyhighocs:dyn/wave_changing_timer") == 0) ? true : entity.getData("skyhighocs:dyn/pryetak_timer") == 1);
    };
