...
function init(hero) {
  ...
  hero.setName("Ace Stelar/\u00A74Solar Flame\u00A7r");
  hero.setTier(10);
  ...
  hero.setKeyBindEnabled((entity, keyBind) => {
    ...
    if (keyBind == "SHAPE_SHIFT") {
      return entity.getData("skyhighocs:dyn/battle_card") == 0 && ((entity.getData("skyhighocs:dyn/wave_changing_timer") == 0) ? true : entity.getData("skyhighocs:dyn/solar_timer") == 1);
    };
